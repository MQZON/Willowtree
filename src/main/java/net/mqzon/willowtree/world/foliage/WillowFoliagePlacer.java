...
public class WillowFoliagePlacer extends FoliagePlacer {
    ...
    public WillowFoliagePlacer(IntProvider radius,
                               IntProvider offset,
                               IntProvider height,
    ...
    protected FoliagePlacerType<?> getType() {
        return ModFoliagePlacerTypes.WILLOW_FOLIAGE_PLACER;
    }
    ...
    protected void generate(
        ...
        BlockPos blockPos = treeNode.getCenter().down(offset); // Lower the foliage. This differs from the cherry placer.
